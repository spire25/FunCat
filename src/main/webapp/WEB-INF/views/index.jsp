...
<body>
					...
					<div class="hero__search" >
						<div class="hero__search__form" >
							<form action="project/search" method="GET">
								...
								<button type="submit" class="site-btn" style="float:right; background-color: #f0b000;">검색</button>
							</form>
						</div>
					</div>
               <!--  </div> -->
    ...
    <center>
        <div class="slideshow-container">
            <div class="imgSlide fade">
              ...
              <img src="https://images.unsplash.com/photo-1585366119957-e9730b6d0f60?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1742&q=80" style="width:100%">
            </div>

            <div class="imgSlide fade">
              <div class="numbertext">2 / 3</div>
              <img src="https://cdn.wadiz.kr/ft/images/green001/2022/0204/20220204184841483_3.gif" style="width:100%">
            </div>

            <div class="imgSlide fade">
              <div class="numbertext">3 / 3</div>
              <img src="https://cdn.wadiz.kr/ft/images/green001/2022/0210/20220210013941933_84.png/wadiz/format/jpg/quality/80/optimize" style="width:100%">
            </div>
        </div>
        </br>
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <!-- 반복문 -->
            	<c:if test="${ empty mainList }">등록된 프로젝트가 없습니다.</c:if>
                <c:forEach items="${mainList}" var="project">
	                    ...
	                    <div class="featured__item">
	                        ...
	                        <div class="featured__item__pic set-bg">
	                            ...
	                            <figure class="img_scale">
	                            	<!-- src='<s:url value="${project.PROJECT_THUMBNAIL }"></s:url>'  -->
