		...
		{	
				if (confirm("수정하시겠습니까??") == true){    //확인				
					  $.post( "myUpdate.do", { 
						 ...
						 member_pw: document.getElementById('pw').value,
						 member_phone: document.getElementById('phone').value
						 } )
					  .done(function( data ) {
					   		if(data == "ok"){
  ...
  <button type="button" class="btn btn-outline-warning" onclick= "modifycheck('${mypage.member_id}');" input type='submit'>Modify</button></h3>
 	<br>
	    ...
	    <tr>
		  ...
		  <tr>
		    <td>Nick name</td>
		    <td><textarea id='name'  name='member_name' rows='1' cols='20' >${mypage.member_name}</textarea></td>
		  </tr>
		  <tr>
		    <td>Password</td>
		    <td><textarea id='pw' name='member_pw' rows='1' cols='20' >${mypage.member_pw}</textarea></td>
		  </tr>
		  <tr>
		    <td>Contact</td>
		    <td><textarea id='phone'  name='member_phone' rows='1' cols='20' >${mypage.member_phone}</textarea></td>
		  </tr>
		  <tr>
		    <td>E-mail check</td>
