                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <textarea class="form-control h-25" rows="10" name="notice_con" id="notice_con" placeholder="*공지사항관리자만 작성 가능*" style="max-width: 750px; min-width: 300px; resize: none;"> <c:out value="${pageInfo.notice_con}"/></textarea>
